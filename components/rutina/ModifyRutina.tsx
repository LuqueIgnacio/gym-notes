...
export default function ModifyRutina({cantidadEjerciciosSeleccionadosState, ejerciciosState, onSave,}) {
  const [ejercicios, setEjercicios] = ejerciciosState;
